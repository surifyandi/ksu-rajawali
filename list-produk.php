	...
	<body>
		...
		<section class="content">
			<div class="container">
				...
				<!-- side left -->
				<div class="col-md-9 left-bar list-product">
					<div class="row">
						<article class="col-md-6 col-sm-6">
							<img src="images/thumb/product/produk-1.jpg" />
							<a href="detail-produk.php"><h4>Kerajinan Tenun Tikar</h4></a>
							...
							<a href="detail-produk.php" class="more">Selengkapnya &nbsp<i class="fa fa-long-arrow-right"></i></a>
						</article>
						
						<article class="col-md-6 col-sm-6">
							<img src="images/thumb/product/produk-2.jpg" />
							<a href="detail-produk.php"><h4>Gula Aren Jahe</h4></a>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmodtempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam...</p>
							<a href="detail-produk.php" class="more">Selengkapnya &nbsp<i class="fa fa-long-arrow-right"></i></a>
						</article>
					</div>
					<div class="row">
						<article class="col-md-6 col-sm-6">
							...
							<a href="detail-produk.php"><h4>Souvenir</h4></a>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmodtempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam...</p>
							<a href="detail-produk.php" class="more">Selengkapnya &nbsp<i class="fa fa-long-arrow-right"></i></a>
						</article>
						...
						<article class="col-md-6 col-sm-6">
							...
							<a href="detail-produk.php"><h4>Iguana Kopi</h4></a>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmodtempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam...</p>
							<a href="detail-produk.php" class="more">Selengkapnya &nbsp<i class="fa fa-long-arrow-right"></i></a>
						</article>
					</div>
