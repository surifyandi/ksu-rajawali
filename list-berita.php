		...
		<section class="content">
			<div class="container">
				...
				<div class="col-md-9 left-bar list-news">
					<article class="row">
						<figure class="col-md-4 col-sm-4">
						...
						<div class="col-md-8 col-sm-8">
							...
							<a href="detail-berita.php"><h4>Pemerintah Bakal Bekukan 61 Ribu Koperasi Seluruh Indonesia</h4></a>
							<p>Sebanyak 61 ribu koperasi di seluruh Indonesia terancam dibekukan. Dari jumlah tersebut, sekitar 9.968 koperasi berada di wilayah Jawa Barat ...</p>
							<a href="detail-berita.php" class="more">Selengkapnya &nbsp<i class="fa fa-long-arrow-right"></i></a>
						</div>
					</article>
					...
					<article class="row">
						...
						<div class="col-md-8 col-sm-8">
							...
							<a href="detail-berita.php"><h4>Jokowi : Hadapi Persaingan, Koperasi Harus Mau Bergabung</h4></a>
							<p>Presiden Joko Widodo (Jokowi) meminta kepada para pelaku usaha nasional untuk siap menghadapi persaingan global. Menurut Jokowi, persaingan yang ...</p>
							<a href="detail-berita.php" class="more">Selengkapnya &nbsp<i class="fa fa-long-arrow-right"></i></a>
						</div>
					</article>
					...
					<article class="row">
						...
						<div class="col-md-8 col-sm-8">
							...
							<a href="detail-berita.php"><h4>Menkop UKM Puspayoga: Bentuk Koperasi Bukan Hanya Cari Dana</h4></a>
							<p>Puncak peringatan Hari Koperasi Nasional ke-69 diselenggarakan pada Kamis pekan ini di Jambi. Selain Menteri Koperasi dan Usaha Kecil Menengah (UKM) ...</p>
							<a href="detail-berita.php" class="more">Selengkapnya &nbsp<i class="fa fa-long-arrow-right"></i></a>
						</div>
					</article>
